...
<div class="col-12">
    <div class="card">
        ...
        <div class="card-header">
            <h4 class="card-title"><strong>Packages</strong></h3>
                <div class="col-md-2" style="float:right;">

                    <a href="{{ route('package.create') }}">

                        <button type="button" title="Add Package" class="btn btn-danger">
        ...
        <div class="card-body table-responsive p-0" style="height: 300px;">
            <table class="table table-head-fixed text-nowrap">
                ...
                <td>
                    <form action="{{ route('package.destroy', $data->id) }}" method="POST">
                        <a class="btn btn-primary" title="Edit" href="{{ route('package.edit', $data->id) }}">
                            <i class="fa fa-pen"></i>
                        </a>
                        @csrf
                        @method('DELETE')
