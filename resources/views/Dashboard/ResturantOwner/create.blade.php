...
<div class="card">
    <div class="card-body register-card-body">
        <p class="login-box-msg">Add new owner resturant</p>
        <form action="{{ route('resturant.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="">
                <label for="email">Owner Name*</label>
                <input style="width: 100%" id="name" name="name" type="text" class="required_field" />
            </div>
            <div class="">
                <label for="resturant_name">Resturant Name*</label>
                <input style="width: 100%" id="resturant_name" name="resturant_name" type="text" class="required_field" />
            </div>
            <div class="">
                <label for="email">Email*</label>
                <input style="width: 100%" id="email" name="email" type="text" class="required_field" />
            </div>
            <div class="">
            ...
            <div class="">
             <label for="password">Resturant Image*</label>
                <input class="form-control" placeholder="Image" type="file" name="image" accept="image/*" onchange="loadFile(event)">
