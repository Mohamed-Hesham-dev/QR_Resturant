        ...
        <div id="rev_slider_3_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-source="gallery" style="margin:0px auto;background:#262626;padding:0px;margin-top:0px;margin-bottom:0px;">
            ...
            <div id="rev_slider_3_1" class="rev_slider fullwidthabanner tp-overflow-hidden" style="display:none;" data-version="5.4.8">
                <ul>
                    ...
                    <li data-index="rs-3" data-transition="zoomin" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb={{ asset('assets/frontend/upload/sella.jpeg') }} data-rotate="0" data-saveperformance="on" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src={{ asset('assets/frontend/upload/sella.jpeg') }} alt="" title="abreakey-raw-foodphotography-squid-still-life" width="1400" height="1049" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                ...
                <div class="d-flex flex-column align-items-start">
                    ...
                    <div style="margin-top:-5px">
                        <ul class="d-flex justify-content-center gap-4 list-unstyled mt-2">
                            <li class="facebook soci"><a target="_blank" title="Facebook" href="{{ $contactUs->facebook ?? ' ' }}"><i class="fa fa-facebook  social fs-9"></i></a>
                            </li>

                            <li class="youtube soci"><a target="_blank" title="Youtube" href="{{ $contactUs->youtube ?? ' ' }}"><i class="fa fa-youtube social fs-9"></i></a>
                            </li>

                            <li class="instagram soci"><a target="_blank" title="Instagram" href="{{ $contactUs->instagram ?? '' }}"><i class="fa fa-instagram social fs-9"></i></a>
                            </li>
                        </ul>
                    </div>
                    <div class="  mt-1">
                        <div>
                            <nav class=" d-flex gap-4 nav-pills nav-fill">
                                ...
                                <a class="  btn btn-light p-2" href={{ route('resturant.category', $category->category_name) }}>{{ $category->category_name }}</a>
                                @endforeach
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row align-items-center justify-contnet-center">
                    ...
                    <div class=" col-6 col-md-3 ">
                        <a id="modalnfo" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="openProductModal(this);" data-product="{{ json_encode($product) }}">
                            <img src={{ asset($product->logo) }} class="card-img-top" style="width: 100%; border-radius:50%;   " alt="...">
    ...
    <div class="slider_wrapper portfolio">
        <div class="flexslider tg_gallery" data-height="750">
            <ul class="slides">
                ...
                <li><img src={{ asset('assets/frontend/upload/slide-02_tom-aikens-food-photography.jpg') }} alt="" />
                ...
                <li><img src={{ asset('assets/frontend/upload/indian-food-with-chapatti-rice-curries-vegetables-papad-pickle-payasam-f4.jpg') }} alt="" />
                ...
                <li><img src={{ asset('assets/frontend/upload/plae_bistro_ad_food_photography_milwaukee_advertising_photographer_appleton_wisconsin_culinary_photography_retouching_preparation_cuisine_11.jpg') }} alt="" />
            ...
            <div class="reservation_form_wrapper">
                ...
                <form id="tg_reservation_form" action={{ route('reservation') }} method="post">
                    ...
                    <div class="one_third">
                        ...
                        <input type="text" class="  required_field" id="date" name="date" value="05/10/2019">
                    </div>
                    <div class="one_third">
        ...
        modal._element.addEventListener('shown.bs.modal', function(event) {
            $.ajax({
                ...
                , success: function(response) {
                    ...
                    var optionsContainer = modal._dialog.querySelector('.options-container');
                    ...
                    $.each(response.result, function(index, val) {
                        var optionElement = $('<p>').text(val.option);
                        ...
                        optionsContainer.appendChild(optionElement[0]);
                    });
                }
