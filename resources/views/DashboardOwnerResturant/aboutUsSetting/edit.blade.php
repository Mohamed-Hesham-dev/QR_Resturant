...
@section ('content')
    ...
    <div class="card">
        <div class="card-body register-card-body">
            ...
            <form action="{{ route('aboutUsSettingResturant.update', $all_aboutUsSetting->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="">
                    <label for="resturant_name">Resturant Name*</label>
                    <input class="required_field form-control" id="resturant_name" name="resturant_name" type="text" value="{{$all_aboutUsSetting->resturant_name}}"/>
                </div>
               <div class="">
