...
<div class="col-12">
    <div class="card">
        ...
        <div class="card-header">
            <h4 class="card-title"><strong>Options</strong></h3>
                <div class="col-md-2" style="float:right;">

                    <a href="{{ route('options.create') }}">

                        <button type="button" title="Add Option" class="btn btn-danger">
        ...
        <div class="card-body table-responsive p-0" style="height: 300px;">
            <table class="table table-head-fixed text-nowrap">
                ...
                <tbody>
                    @foreach ($all_poptions as $data)
                    <td>{{ $data->id}}</td>
                    <td>{{ $data->option_name }}</td>
                  
                    <td>
                        <form action="{{ route('options.destroy', $data->id) }}" method="POST">
                            <a class="btn btn-primary" title="Edit" href="{{ route('options.edit', $data->id) }}">
                                <i class="fa fa-pen"></i>
                            </a>
                            @csrf
                            @method('DELETE')
