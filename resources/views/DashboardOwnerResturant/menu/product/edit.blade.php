...
@section('content')
    <div class="card card-primary">
        ...
        <form action="{{ route('products.update', $resturantProductDashboard->id) }}" method="POST"
            ...
            <div class="card-body  ">
                    ...
                    <select name="category_id" class="form-control">
                        ...
                        @foreach ($categories as $value)
                            <option value="{{ $value->id }}"
                                {{ $value->id == $resturantProductDashboard->category_id ? 'selected' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <input class="required_field form-control" id="name" name="name" type="text"
                        value="{{ $resturantProductDashboard->name }}" />
                </div>
                    ...
                    <div class="input-group">
                        <div class="custom-file">
                            <input type="file" class="form-control" name="logo" placeholder="Image"
                                id="exampleInputFile" onchange="loadFile(event)" accept="image/*" value="{{ $resturantProductDashboard->logo }}">
                ...
                @if (count($resturantProductDashboard->options) > 0)
                            ...
                            <div id="first" class="row">
                                <div class="col">
                                    ...
                                    <select class="form-control" name="options[]"
                                        onChange="changeOptions(event,{{ $key }})"
                                        id="option-{{ $key }}">
                                ...
                                <div class="col">
                                    <label> price</label>
                                    <input type="number" min="1" name="prices[]" class="form-control"
                                        placeholder="price" value="{{ $item->pivot->price }}">
                                </div>
                                <div class="col">

                                    <button type="button" title="Remove"
                                        @if ($key == 0) disabled="disabled" @endif
                                        style="height:43px; margin-top:29px"
                                        class="btn btn-danger btn-option delete-repeat">
                    ...
                    <button type="button" class="btn btn-primary btn-icon-split " style=" margin-left: 20px;"
                        id="button-repeat" data-key="{{ count($resturantProductDashboard->options) - 1 }}"> <span
                ...
                @else
                    <div class="items-0">
                        <div id="first" class="row">
                            <div class="col">
                                <label>Options</label>
                                <select class="form-control" name="options[]" onChange="changeOptions(event,0)"
                                    id="option-0">
                            ...
                            <div class="col">
                                ...
                                <button type="button" title="Remove" style="height:43px; margin-top:29px"
                                    disabled="disabled" class="btn btn-danger btn-option delete-repeat">
                                    <i class="fa fa-minus-circle"></i>
                                </button>
                            </div>
                        </div>
