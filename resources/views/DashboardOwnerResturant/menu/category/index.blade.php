...
<div class="col-12">
    <div class="card">
        ...
        <div class="card-header">
            <h4 class="card-title"><strong>Categories</strong></h3>
                <div class="col-md-2" style="float:right;">

                    <a href="{{ route('categories.create') }}">

                        <button type="button" title="Add Category" class="btn btn-danger">
                ...
                <tbody>
                    ...
                    <td>
                        <form action="{{ route('categories.destroy', $data->id) }}" method="POST">
                            <a class="btn btn-primary" title="Edit" href="{{ route('categories.edit', $data->id) }}">
                                <i class="fa fa-pen"></i>
                            </a>
                            @csrf
                            @method('DELETE')
