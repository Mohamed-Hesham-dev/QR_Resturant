            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select name="area" class="form-control">
                        ...
                        <option value="inside"{{ $resturantTableDashboard->area == 'inside' ? 'selected' : '' }}>Inside
                        </option>
                        <option value="outside" {{ $resturantTableDashboard->area == 'outside' ? 'selected' : '' }}>Outside
                        </option>
                ...
                <div class="input-group mb-3">
                    ...
                    <input class="checkbox form-control" type="checkbox" name="is_active" id="switch" value="1"
                        {{ $resturantTableDashboard->is_active == 1 ? 'checked' : '' }}>
