...
<div class="col-12">
    <div class="card">
        ...
        <div class="card-header">
            <h4 class="card-title"><strong>Tables</strong></h3>
                <div class="col-md-2" style="float:right;">

                    <a href="{{ route('table.create') }}">

                        <button type="button" title="Add Table" class="btn btn-danger">
                ...
                <tbody>
                    ...
                    <td>
                        <form action="{{ route('table.destroy', $data->id) }}" method="POST">
                            <a class="btn btn-primary" title="Edit" href="{{ route('table.edit', $data->id) }}">
                                <i class="fa fa-pen"></i>
                            </a>
                            @csrf
                            @method('DELETE')
                            ...
                            <a href="{{ route('qrcode.generate',$data->id) }}" title="QR Code" class="btn btn-primary"><i class="fas fa-qrcode"></i></a>
