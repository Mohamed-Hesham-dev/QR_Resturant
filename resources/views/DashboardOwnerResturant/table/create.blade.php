...
<div class="card">
    <div class="card-body register-card-body">
        <p class="login-box-msg">Add new Table</p>
        <form action="{{ route('table.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="">
                ...
                <input style="width: 100%" id="name" name="num_table" type="number" class="required_field" />
            </div>
            <div class="">
                <label for="email">Number Of Chairs*</label>
                <input style="width: 100%" id="name" name="num_chairs" type="number" class="required_field" />
            </div>
